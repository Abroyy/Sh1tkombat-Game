...
public class Char7 : MonoBehaviour
{
    ...
    {
        ileriHareket = true;
        anim.SetBool("charwalk7",true);
    }

    public void OnReleaseIleri()
    {
        ileriHareket = false;
        anim.SetBool("charwalk7",false);
    }
    ...
    public void DisableDefence()
    {
        ...
        anim.SetBool("chardefence7", false);
    }
    public void EnableDefence()
    {
        isDefenceActive = true;
        anim.SetBool("chardefence7", true);
    }
    ...
    void firstSkillShoot()
    {
        if (firstskillbutton == true && attackTimer <= 0)
        {
            ...
            anim.SetTrigger("charfirstskill7");
            muzikbutton1.Play();
            if (scaler.x <=0)
            {
    ...
    void secondSkillShoot()
    {
        if (secondskillbutton == true && attackTimer2 <= 0)
        {
            ...
            muzikbutton2.Play();
            anim.SetTrigger("charsecondskill7");

...
public class Char5 : MonoBehaviour
{
    ...
    public float characterscalex = 0.15f;
    ...
    {
        ileriHareket = true;
        anim.SetBool("charwalk5",true);
    }

    public void OnReleaseIleri()
    {
        ileriHareket = false;
        anim.SetBool("charwalk5",false);
    }
    ...
    public void DisableDefence()
    {
        ...
        anim.SetBool("chardefence5", false);
    }
    public void EnableDefence()
    {
        isDefenceActive = true;
        anim.SetBool("chardefence5", true);
    }
    ...
    void firstSkillShoot()
    {
        if (firstskillbutton == true && attackTimer <= 0)
        {
            ...
            anim.SetTrigger("charfirstskill5");
            muzikbutton1.Play();
            if (scaler.x <=0)
            {
    ...
    void secondSkillShoot()
    {
        if(secondskillbutton == true &&attackTimer2 <= 0 )
        {
            ...
            muzikbutton2.Play();
            anim.SetTrigger("charsecondskill5");

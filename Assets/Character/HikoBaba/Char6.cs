...
public class Char6 : MonoBehaviour
{
    ...
    public float secondskillcooldawn = 6f;
    ...
    public float characterscalex = 0.5f;
    ...
    public AudioSource button1muzik;
    public AudioSource button2muzik;
    ...
    {
        ileriHareket = true;
        anim.SetBool("charwalk6",true);
    }

    public void OnReleaseIleri()
    {
        ileriHareket = false;
        anim.SetBool("charwalk6",false);
    }
    ...
    public void DisableDefence()
    {
        ...
        anim.SetBool("chardefence6", false);
    }
    public void EnableDefence()
    {
        isDefenceActive = true;
        anim.SetBool("chardefence6", true);
    }
    ...
    void firstSkillShoot()
    {
        if (firstskillbutton == true && attackTimer <= 0)
        {
            ...
            anim.SetTrigger("charfirstskill6");
            button1muzik.Play();
    ...
    void secondSkillShoot()
    {
        if (secondskillbutton == true && attackTimer2 <= 0)
        {
            ...
            anim.SetTrigger("charsecondskill6");
            button2muzik.Play();
            if (scaler.x <= 0)
            {
                Rigidbody2D rb = mermi.GetComponent<Rigidbody2D>();

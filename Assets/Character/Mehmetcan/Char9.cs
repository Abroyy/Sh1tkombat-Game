...
public class Char9 : MonoBehaviour
{
    ...
    public float characterscalex = 0.24f;
    ...
    {
        ileriHareket = true;
        anim.SetBool("charwalk9",true);
    }

    public void OnReleaseIleri()
    {
        ileriHareket = false;
        anim.SetBool("charwalk9",false);
    }
    ...
    public void DisableDefence()
    {
        ...
        anim.SetBool("chardefence9", false);
    }
    public void EnableDefence()
    {
        isDefenceActive = true;
        anim.SetBool("chardefence9", true);
    }
    ...
    void firstSkillShoot()
    {
        if (firstskillbutton == true && attackTimer <= 0)
        {
            ...
            anim.SetTrigger("charfirstskill9");
            if (scaler.x <=0)
            {
    ...
    void secondSkillShoot()
    {
        ...
        {
            anim.SetTrigger("charsecondskill9");
            muzikbutton2.Play();
            attackDamage = 20f;
            DamageEnemy();

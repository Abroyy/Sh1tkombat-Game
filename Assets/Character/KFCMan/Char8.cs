...
public class Char8 : MonoBehaviour
{
    ...
    public float characterscalex = 0.19f;
    ...
    {
        ileriHareket = true;
        anim.SetBool("charwalk8",true);
    }

    public void OnReleaseIleri()
    {
        ileriHareket = false;
        anim.SetBool("charwalk8",false);
    }
    ...
    public void DisableDefence()
    {
        ...
        anim.SetBool("chardefence8", false);
    }
    public void EnableDefence()
    {
        isDefenceActive = true;
        anim.SetBool("chardefence8", true);
    }
        ...
        public void CharacterTakeDamage(float damage)
    {
        if (isShieldActive == true)
        {
            ...
            Debug.Log("Zarar tamamen engellendi");
        }
         
        else if (isDefenceActive==true)
        {
    ...
    void firstSkillShoot()
    {
        if (firstskillbutton == true && attackTimer <= 0)
        {
            ...
            anim.SetTrigger("charfirstskill8");
            if (scaler.x <=0)
            {
    ...
    void secondSkillShoot()
    {
        ...
        // Kalkan� etkinle�tirmek veya devre d��� b�rakmak i�in bir tu�a basabilirsiniz.
        if (secondskillbutton == true && a <= 0)
        {
            if (!isShieldActive)
            {
                muzikbutton2.Play();
                anim.SetTrigger("charsecondskill8");
                EnableShield();

...
public class Char14 : MonoBehaviour
{
    ...
    {
        ileriHareket = true;
        anim.SetBool("charwalk14",true);
    }

    public void OnReleaseIleri()
    {
        ileriHareket = false;
        anim.SetBool("charwalk14",false);
    }
    ...
    public void DisableDefence()
    {
        ...
        anim.SetBool("chardefence14", false);
    }
    public void EnableDefence()
    {
        isDefenceActive = true;
        anim.SetBool("chardefence14", true);
    }
    ...
    void firstSkillShoot()
    {
        if (firstskillbutton == true && attackTimer <= 0)
        {
            ...
            anim.SetTrigger("charfirstskill14");
            if (scaler.x <=0)
            {

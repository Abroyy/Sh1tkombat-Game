...
public class Char3 : MonoBehaviour
{
    ...
    {
        ileriHareket = true;
        anim.SetBool("charwalk3",true);
    }

    public void OnReleaseIleri()
    {
        ileriHareket = false;
        anim.SetBool("charwalk3",false);
    }
    ...
    public void DisableDefence()
    {
        ...
        anim.SetBool("chardefence3", false);
    }
    public void EnableDefence()
    {
        isDefenceActive = true;
        anim.SetBool("chardefence3", true);
    }
    ...
    void firstSkillShoot()
    {
        if (firstskillbutton == true && attackTimer <= 0)
        {
            ...
            anim.SetTrigger("charfirstskill3");
            muzikbutton1.Play();
            if (scaler.x <=0)
            {

...
public class Char1 : MonoBehaviour
{
    ...
    {
        ileriHareket = true;
        anim.SetBool("charwalk1",true);
    }

    public void OnReleaseIleri()
    {
        ileriHareket = false;
        anim.SetBool("charwalk1",false);
    }
    ...
    public void EnableDefence()
    {
        ...
        anim.SetBool("chardefence1", true);
    }    
    public void DisableDefence()
    {
        isDefenceActive = false;
        anim.SetBool("chardefence1", false);
    }
    ...
    void firstSkillShoot()
    {
        if (firstskillbutton ==true && attackTimer <= 0)
        {
            ...
            anim.SetTrigger("charfirstskill1");
            if (scaler.x <=0)
            {

...
public class AI4 : MonoBehaviour
{
    ...
    public float attackRange2 = 300f;
    ...
    public float secondskillcooldawn = 20f;
    private float attackTimer = 5f;
    private float timer = 2;
    private float timer2 = 2;
    float distance;
    public float enemyscalex = 0.18f;
    Vector2 scaler;
   ...
   public GameObject youwin;
    ...
    void MoveTowardsPlayer()
    {
        ...
        if(step==0){
            anim.SetBool("Enemywalk4",false);
        }
        else{
            anim.SetBool("Enemywalk4",true);
        }
    }
    ...
    void EfirstSkillShoot()
    {
        if (distance > 1.2 || distance < -1.2)
        {
            if (bulletattackTimer <= 0)
            {
                ...
                muzikbutton1.Play();
                anim.SetTrigger("Enemyfirstskill4");
    ...
    void ESEcondSkillShoot()
    {
        ...
        {
            muzikbutton2.Play();
            Collider2D[] hitCharacter = Physics2D.OverlapCircleAll(attackPoint2.position, attackRange2, enemyLayers);
            foreach (Collider2D enemy in hitCharacter)
            {
                if (enemy.name == "1")
                {
                    enemy.GetComponent<Char1>().bearskill();
                }
                else if (enemy.name == "2")
                {
                    enemy.GetComponent<Char2>().bearskill();
                }
                else if (enemy.name == "3")
                {
                    enemy.GetComponent<Char3>().bearskill();
                }
                else if (enemy.name == "4")
                {
                    enemy.GetComponent<Char4>().bearskill();
                }
                else if (enemy.name == "5")
                {
                    enemy.GetComponent<Char5>().bearskill();
                }
                else if (enemy.name == "6")
                {
                    enemy.GetComponent<Char6>().bearskill();
                }
                else if (enemy.name == "7")
                {
                    enemy.GetComponent<Char7>().bearskill();
                }
                else if (enemy.name == "8")
                {
                    enemy.GetComponent<Char8>().bearskill();
                }
                else if (enemy.name == "9")
                {
                    enemy.GetComponent<Char9>().bearskill();
                }
                else if (enemy.name == "10")
                {
                    enemy.GetComponent<Char10>().bearskill();
                }
                else if (enemy.name == "11")
                {
                    enemy.GetComponent<Char11>().bearskill();
                }
                else if (enemy.name == "12")
                {
                    enemy.GetComponent<Char12>().bearskill();
                }
                else if (enemy.name == "13")
                {
                    enemy.GetComponent<Char13>().bearskill();
                }
                else if (enemy.name == "14")
                {
                    enemy.GetComponent<Char14>().bearskill();
                }

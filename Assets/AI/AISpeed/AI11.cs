...
public class AI11 : MonoBehaviour
{
    ...
    public float secondskillcooldawn = 16f;
    public float secondskillspeed=4f;
    ...
    public void TakeDamage(float damage)
    {
        if (attackTimer2 <= 0)
        {
            ...
            anim.SetTrigger("Enemydefence11");
            damage -= 4;
    ...
    void MoveTowardsPlayer()
    {
        ...
        if(step==0){
            anim.SetBool("Enemywalk11",false);
        }
        else{
            anim.SetBool("Enemywalk11",true);
        }
    ...
    void EfirstSkillShoot()
    {
        if (distance > 1.2 || distance < -1.2)
        {
            if (bulletattackTimer <= 0)
            {
                ...
                muzikbutton1.Play();
                anim.SetTrigger("Enemyfirstskill11");
